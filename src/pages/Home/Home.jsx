		...
		<Section>
			<div className="featured-film_background">
				...
				>
					...
					<Container width="100%" className="featured-synopse">
						Scott Lang e Hope van Dyne em suas jornadas como
						super-heróis. Scott e sua família são puxados para o
						Reino Quântico, onde eles precisarão enfrentar um
						novo e terrível vilão: Kang, o Conquistador e
						M.O.D.O.K..
					</Container>
